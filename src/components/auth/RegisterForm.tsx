    ...
    return (
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="mb-4">
                ...
                <p className="text-xs text-muted-foreground">Comece sua jornada no Project Lumo.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-2.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div className="space-y-1">
                        <Label htmlFor="name" className="text-[11px] font-semibold text-foreground">
                            Nome
                        </Label>
                ...
                {passwordValue && (
                    <div className="flex items-center gap-3 pt-0.5 text-[10px]">
                        <span
                            className={`flex items-center gap-1 ${hasMinLength ? "text-emerald-500 font-medium" : "text-muted-foreground"}`}
                        >
                            {hasMinLength ? (
                        ...
                        <span
                            className={`flex items-center gap-1 ${hasLetter ? "text-emerald-500 font-medium" : "text-muted-foreground"}`}
                        >
                            {hasLetter ? (
                                <CheckCircle2 className="w-3 h-3" />
                            ) : (
                        ...
                        <span
                            className={`flex items-center gap-1 ${hasNumber ? "text-emerald-500 font-medium" : "text-muted-foreground"}`}
                        >
                            {hasNumber ? (
                                <CheckCircle2 className="w-3 h-3" />
                            ) : (
            ...
            <div className="mt-4 text-center pt-3 border-t border-border">
                <p className="text-xs text-muted-foreground mb-1.5">Já faz parte da jornada?</p>
                <Button
                    type="button"
