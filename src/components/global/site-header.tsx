        ...
        <header className="sticky top-0 z-40 w-full border-b border-border bg-white dark:bg-black text-slate-900 dark:text-foreground transition-colors duration-200">
            <div className="flex h-16 items-center justify-between px-6 max-w-[1200px] mx-auto relative">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/" className="flex items-center gap-1.5 font-extrabold text-sm tracking-tight hover:opacity-80 transition-opacity">
                        <span>✨</span>
                    </Link>
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    {isAuthenticated && (
                        <>
                            ...
                            <Button asChild variant="outline" size="icon" className="h-9 w-9 border-border hover:text-primary transition-colors" title="Adicionar Jogo">
                                <Link href="/games/new">
                            ...
                            <Button variant="ghost" size="icon" className="relative text-muted-foreground hover:text-primary transition-colors" title="Notificações">
