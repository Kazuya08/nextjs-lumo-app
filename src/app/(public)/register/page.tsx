                        ...
                        <div className="space-y-8 animate-fadeIn">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-[11px] text-muted-foreground -mt-1">
                                    Recomendado: 512 × 512 px • JPG, PNG ou WEBP
                                </p>
                                <div className="flex flex-col sm:flex-row items-center gap-5">
                                    <div className="relative group">
                                        <div className="relative w-24 h-24 rounded-full border-2 border-border bg-secondary overflow-hidden flex items-center justify-center shadow-md">
                                            {formData.avatar ? (
                                                <Image
                                                    src={formData.avatar}
                                                    alt="Avatar preview"
                                    ...
                                    <div className="p-4 rounded-xl bg-background/60 border border-border flex items-center gap-3 animate-fadeIn">
                                        ...
                                        <div className="flex gap-2">
                                            {DEFAULT_AVATARS.map((url, index) => (
                                                <div
                                                    key={index}
                                                    className="relative w-10 h-10 rounded-full overflow-hidden border border-border hover:border-primary transition-all"
                                                >
                                                    <Image
                                                        src={url}
                                                        alt={`Avatar ${index + 1}`}
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div className="space-y-1.5">
                                    ...
                                    <p className="text-[11px] text-foreground font-light">
                                        É assim que você será conhecido dentro da plataforma.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <p className="text-[11px] text-muted-foreground font-light">
                                        De onde você acompanha sua jornada gamer?
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 pt-2">
                                <div>
                                    <h3 className="text-sm font-semibold text-secondary-foreground">
                                        Quer deixar suas outras jornadas por aqui também?
                                    </h3>
                                    <p className="text-xs text-popover-foreground font-light">
                                        Adicione links externos opcionais para que outras pessoas
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-fadeIn">
                            <div>
                                ...
                                <p className="text-sm sm:text-base text-popover-foreground font-light">
                                    Não existe jeito certo ou errado de viver sua jornada. Escolha o
                                    perfil que mais combina com você.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div
                                    onClick={() =>
                                        setFormData({ ...formData, playerStyle: "casual" })
                                    }
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-xs text-foreground/80 leading-relaxed mb-4 font-light">
                                            &ldquo;Jogo porque gosto. Quero registrar o que
                                            terminei, quando terminei e o que achei.&rdquo;
                                        </p>
                                    </div>
                                ...
                                <div
                                    onClick={() =>
                                        setFormData({ ...formData, playerStyle: "entusiasta" })
                                    }
                                    className={`p-5 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between ${
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-xs text-foreground/80 leading-relaxed mb-4 font-light">
                                            &ldquo;Gosto de guardar um pouco mais da experiência. Às
                                            vezes escrevo review, acompanho conquistas e
                                            detalhes.&rdquo;
                                        </p>
                                    </div>
                                    <div className="pt-3 border-t border-border/60 text-[11px] text-primary/90 font-medium">
                                        &ldquo;Mais detalhes para quem gosta de lembrar de cada
                                        aventura.&rdquo;
                                    </div>
                                </div>
                                ...
                                <div
                                    onClick={() =>
                                        setFormData({ ...formData, playerStyle: "tryhard" })
                                    }
                                    className={`p-5 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between ${
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-xs text-foreground/80 leading-relaxed mb-4 font-light">
                                            &ldquo;Quero ir além de terminar. Gosto de completar
                                            tudo, 100%, platinar, bater tempos e explorar cada
                                            detalhe.&rdquo;
                                        </p>
                                    </div>
                                    <div className="pt-3 border-t border-border/60 text-[11px] text-primary/90 font-medium">
                            ...
                            <div className="p-5 rounded-2xl bg-background border border-border/80 space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs font-semibold text-popover-foreground uppercase tracking-wider flex items-center gap-1.5">
                                        ...
                                        Prévia Conceitual do Perfil (
                                        {formData.playerStyle.toUpperCase()})
                                    </span>
                                    <span className="text-[11px] text-muted-foreground">
                                        O estilo altera apenas a hierarquia visual, não bloqueia
                                        recursos.
                                    </span>
                                </div>
                                ...
                                <div className="p-4 rounded-xl bg-secondary/80 border border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                    <div className="flex items-center gap-3">
                                        <div className="relative w-12 h-16 rounded-lg bg-secondary border border-border overflow-hidden shrink-0">
                                            <Image
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] text-popover-foreground">
                                                Terminado em 12 de Outubro
                                            </p>
                                        </div>
                                    </div>
                    ...
                    {step === 3 && (
                        <div className="space-y-6 animate-fadeIn">
                            <div>
                                ...
                                <p className="text-sm sm:text-base text-popover-foreground font-light">
                                    Você acaba de entrar. Agora sua jornada começa oficialmente no
                                    Level 1.
                                </p>
                            </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-popover-foreground">
                                            Quanto mais da sua história você registra, mais você
                                            evolui.
                                        </p>
                                    </div>
                                </div>
                            ...
                            {/* XP Actions Grid */}
                            <div className="space-y-3">
                                <h3 className="text-xs font-semibold text-popover-foreground uppercase tracking-wider">
                                    Como você ganha XP na plataforma
                                </h3>
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                    <div className="p-4 rounded-xl bg-background border border-border/80 space-y-1">
                                        ...
                                        <p className="text-xs text-popover-foreground font-light">
                                            Ganhe XP ao adicionar novos títulos à sua jornada.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-xl bg-background border border-border/80 space-y-1">
                                        ...
                                        <p className="text-xs text-popover-foreground font-light">
                                            Registre o que você achou de cada experiência concluída.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-xl bg-background border border-border/80 space-y-1">
                                        ...
                                        <p className="text-xs text-popover-foreground font-light">
                                            Compartilhe suas impressões detalhadas sobre o jogo.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-xl bg-background border border-border/80 space-y-1">
                                        ...
                                        <p className="text-xs text-popover-foreground font-light">
                                            Mostre quando foi além da conclusão padrão do jogo.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-xl bg-background border border-border/80 space-y-1">
                                        ...
                                        <p className="text-xs text-popover-foreground font-light">
                                            Registre marcos épicos e conquistas máximas.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-5 rounded-2xl bg-background border border-border space-y-3">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h3 className="text-sm font-semibold text-secondary-foreground">
                                            Recompensas e Insígnias Futuras
                                        </h3>
                                        <p className="text-xs text-popover-foreground font-light">
                                            Quanto mais você evolui, mais insígnias exclusivas
                                            desbloqueia no perfil.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-6 text-center py-6 animate-fadeIn max-w-lg mx-auto">
                            ...
                            <div className="p-5 rounded-2xl bg-background border border-border text-left space-y-4">
                                <div className="flex items-center gap-4 pb-4 border-b border-border/80">
                                    <div className="relative w-14 h-14 rounded-full bg-secondary border border-border overflow-hidden flex items-center justify-center font-bold text-popover-foreground">
                                        {formData.avatar ? (
                                            <Image
                                                src={formData.avatar}
                                                alt="Avatar"
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-primary capitalize">
                                            Estilo: {formData.playerStyle} • {formData.country}
                                        </p>
                                    </div>
                                </div>
